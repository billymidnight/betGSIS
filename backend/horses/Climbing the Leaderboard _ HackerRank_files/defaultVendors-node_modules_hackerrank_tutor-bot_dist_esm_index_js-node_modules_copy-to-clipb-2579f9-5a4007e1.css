.link{color:#4691f6;text-decoration:underline;transition:all .5s ease}.link:hover{color:#2ec866;text-decoration:none}.link:active{color:#2ec866}.absolute-center{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.ui-avatar__img,.ui-avatar__initials{border-radius:50%;vertical-align:middle}.ui-avatar__initials{position:relative;display:inline-block;box-sizing:border-box;padding:10px;color:#fff;font-weight:700}
...
/*# sourceMappingURL=https://hrcdn.net/fcore/assets/sourcemaps/defaultVendors-node_modules_hackerrank_tutor-bot_dist_esm_index_js-node_modules_copy-to-clipb-2579f9-5a4007e1.css.map*/