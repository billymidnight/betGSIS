...
export interface BetSelection {
  ...
  decimalOdds: number;
  market?: 'totals' | 'first-guess' | 'country-props' | 'Specials' | 'moneylines' | 'frc' | 'ante' | 'zetamac-totals' | 'zetamac_moneyline' | 'Monopoly' | 'Poker' | 'fifa';
  outcome?: string | null;
  stake: number;
...
interface BetsStore {
  ...
  addSelection: (selection: Omit<BetSelection, 'id' | 'estimatedPayout'> & { market?: 'totals' | 'first-guess' | 'country-props' | 'Specials' | 'moneylines' | 'frc' | 'ante' | 'zetamac-totals' | 'zetamac_moneyline' | 'Monopoly' | 'Poker' | 'fifa' }) => void;
